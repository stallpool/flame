...
const i_env = {
   ...
   server: {
      host: process.env.FLAME_HOST || '127.0.0.1',
      port: parseInt(process.env.FLAME_PORT || '8080'),
      staticDir: (
         process.env.FLAME_STATIC_DIR?
         i_path.resolve(process.env.FLAME_STATIC_DIR):null
      ),
      httpsCADir: (
         process.env.FLAME_HTTPS_CA_DIR?
         i_path.resolve(process.env.FLAME_HTTPS_CA_DIR):null
      ),
   },
};
